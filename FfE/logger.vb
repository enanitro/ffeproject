...
Public Class logger
    ...
    Public Sub analyze_logger_canbus(ByVal path As String, ByRef list As CheckedListBox, ByRef text As TextBox, _
        ...
        Try
            ...
            ids_ch_canbus.Add(971, "min. Batterietemperatur"))
            ids_ch_canbus.Add(1312, "Einspritzung"))
            ids_ch_canbus.Add(1321, "EV Modus"))
            ids_ch_canbus.Add(1324, "Motor-Kühlmitteltemeratur"))
            ids_ch_canbus.Add(1444, "Tankfüllstand"))
